...
This documentation is for developers who want to work with the Vibe codebase. It's a good starting place to experiment with building your own AI-powered app builder.
